...
values ('Минск', (select id from country where name = 'Беларусь')),
       ('Москва', (select id from country where name = 'Россия')),
       ('Париж', (select id from country where name = 'Франция'));
...
values ('Национальный художественный музей Беларуси',
       ...
       ('Лувр', 'Один из крупнейших и самый популярный художественный музей мира. Музей расположен в ' ||
        ...
        (select id from geo where city = 'Париж'));