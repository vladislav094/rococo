...
//  @Nonnull
//  @Query(
//      "select distinct new guru.qa.rococo.data.projection.UserWithStatus(u.id, u.username, u.currency, u.fullname, u.photoSmall, f.status) " +
//      "from UserEntity u left join FriendshipEntity f on " +
//      "(u = f.addressee and f.requester.username = :username) " +
//      "where u.username <> :username " +
//      "and (f.status = guru.qa.rococo.data.FriendshipStatus.PENDING or f.status is null)" +
